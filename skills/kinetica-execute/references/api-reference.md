...
### WMS — Web Map Service (Heatmap, Class-break, Raster, Contour, Labels, Isochrones)
...
> **Before writing WMS code:** read [wms-reference.md](wms-reference.md) for all
> rendering styles, parameter tables, defaults, gotchas, and code examples.

**Rendering styles:** `heatmap`, `raster`, `cb_raster`, `contour`, `labels`, `isochrones`
